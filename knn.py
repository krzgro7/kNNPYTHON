...
from sklearn.model_selection import GridSearchCV # W celu dostrajania hiperparametrw k - nn
...
class PodziałDanych:
    ...
    def wektorowanie(folder, metoda="kNN", min = 5, max = 0.5, słowa_do_usunięcia = False):
        """Tworzenie macierzowej reprezentacji tekstów za pomocą klasy 'TfidfVectorizer' i jej metod 'fit' i 'transform'
               Za pomocą klasy 'TfidfVectorizer' i jej metod 'fit' i 'transform' tworzona jest macierzowa 
